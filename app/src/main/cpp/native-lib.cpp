...
Java_com_eg_lr_wxscan_qr_WeChatQRCode_WeChatQRCode(JNIEnv *env, jobject thiz,
...
Java_com_eg_lr_wxscan_qr_WeChatQRCode_detectAndDecode(JNIEnv *env,
                                                                    jobject thiz,
                                                                    jlong self,
                                                                    jlong img_nativeObj,
...
Java_com_eg_lr_wxscan_qr_WeChatQRCode_delete(JNIEnv *env, jobject thiz, jlong self) {
